...
EMBED_API_BASE_URL = os.getenv("DJANGO_EMBED_API_BASE_URL", "http://localhost:8000").rstrip("/")
...
OPENSEARCH_CONFIG = {
    'hosts': parse_opensearch_hosts(os.getenv("OPENSEARCH_HOSTS", "localhost:9200")),
    'http_auth': (
